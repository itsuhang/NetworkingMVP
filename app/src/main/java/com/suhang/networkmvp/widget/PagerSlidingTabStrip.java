...
import com.suhang.networkmvp.utils.DensityUtil;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabIndicatorPadding = 0;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		drawable = getResources().getDrawable(R.drawable.arrow_down_tab);
	...
	protected void onDraw(Canvas canvas) {
		...
		float arrowLeft = currentTab.getLeft() + (currentTab.getRight() - currentTab.getLeft()) / 2 - DensityUtil.dip2px(20) / 2;
		...
		canvas.drawRect(lineLeft + tabIndicatorPadding, height - indicatorHeight, lineRight - tabIndicatorPadding, height, rectPaint);
		if (isShowArrow) {
			drawable.setBounds((int) arrowLeft, height - DensityUtil.dip2px(5) - DensityUtil.dip2px(5), (int) (arrowLeft + DensityUtil.dip2px(20)), height - DensityUtil.dip2px(5));
